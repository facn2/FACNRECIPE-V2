...
INSERT INTO recipe (recipe_name, recipe_ingredients, recipe_directions, recipe_origin, user_id) VALUES ('Pizza', '2 tablespoons sugar, 1 tablespoon kosher salt ,1 tablespoon pure olive oil, 3/4 cup warm water,2 cups bread flour (for bread machines), 1 teaspoon instant yeast, 2 teaspoons olive oil,Olive oil-for the pizza crust', 'little bit of basil and the Italian will delete thier whole Pizza History', 'Italian', 1);
